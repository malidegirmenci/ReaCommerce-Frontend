...
export default function ContactForm(props) {
    ...
    return (
        <form onSubmit={handleSubmit(onSubmit)} className='flex flex-col gap-4 w-1/2 items-end'>
            ...
            <input className='p-2 bg-gradient-to-r from-[#002229] to-[#01586b]   ring-2 ring-slate-300 rounded text-white placeholder:text-white w-[75%]'type="tel" placeholder="Mobile number" {...register("Mobile number", { required: true, minLength: 6, maxLength: 12 })} />
            <input className='p-2 bg-gradient-to-r from-[#002229] to-[#01586b]  ring-2 ring-slate-300 rounded text-white placeholder:text-white w-[75%]' type="text" placeholder="Subject" {...register("Subject", { max: 20, min: 3, maxLength: 19})} />
