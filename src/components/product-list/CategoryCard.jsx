...
export default function CategoryCard(props) {
    ...
    return (
        <Link
            to={`/shopping/${gender === 'k' ? 'kadin' : 'erkek'}/${code.slice(2)}`}
            className="flex flex-col justify-center items-center bg-cover bg-center w-full h-80 relative cursor-pointer ease-out duration-300 hover:ring-slate-500 hover:ring-4 hover:ease-out hover:duration-300"
