                    ...
                    <div className="max-w-md w-full flex flex-col gap-3">
                        ...
                        <form className=" flex flex-col gap-2 " onSubmit={handleSubmit(onSubmit)}>
                            <div>
                                ...
                                <input id="name" className=" bg-white w-full text-base px-4 py-2 border-b border-gray-300 focus:outline-none rounded-2xl focus:border-indigo-500" type="text" placeholder="Enter your full name" {...register("name", { required: { value: true, message: "Full name is required" }, minLength: { value: 3, message: "You must enter at least 3 characters" }, maxLength: { value: 35, message: "You can enter up to 35 characters." } })} />
                            ...
                            <div >
                                ...
                                <input id='password' className="bg-white w-full content-center text-base px-4 py-2 border-b rounded-2xl border-gray-300 focus:outline-none focus:border-indigo-500" type="password" placeholder="Enter your password" {...register("password", { required: { value: true, message: "Password is required" }, minLength: { value: 8, message: "Password must be at least 8 characters long." }, maxLength: { value: 30, message: "Password cannot be longer than 30 characters." }, pattern: { value: /^(?=.*\d)(?=.*[a-z])(?=.*[A-Z])(?=.*[!@#$%^&*()_+{}\[\]:;<>,.?~\-]).+$/, message: "Password must contain at least one number, one lower case letter, one upper case letter and a special character." } })} />
                            ...
                            <div >
                                ...
                                <input id='passwordConfirmation' className="bg-white w-full content-center text-base px-4 py-2 border-b rounded-2xl border-gray-300 focus:outline-none focus:border-indigo-500" type="password" placeholder="Enter your password" {...register("passwordConfirmation", { validate: (fieldValue) => { return watch("password") === fieldValue || "Password does not match." } })} />
                            ...
                            <div className="flex flex-col">
                                ...
                                <select id='role' value={watch("role") || "customer"} {...register("role")} className='bg-white w-1/2 content-center text-base px-4 py-2 border-b rounded-2xl border-gray-300 focus:outline-none focus:border-indigo-500'>
                                    <option key={3} value={"customer"} defaultValue={"customer"} className='bg-white'>
                                        Customer
                                    </option>
                                    {roles.map(role => (
                                        (role.code !== "customer") &&
                                        <option key={role.id} value={role.code} className='bg-white'>
                                    ...
                                    watch("role")?.toLowerCase() === "store" && (
                                        <>
                                            <div>
                                                ...
                                                <input id="storeName" className=" bg-white w-full text-base px-4 py-2 border-b border-gray-300 focus:outline-none rounded-2xl focus:border-indigo-500" type="text" placeholder="Enter your store name" {...register("storeName", { required: { value: true, message: "Store name is required" }, minLength: { value: 3, message: "Store Name should be at least 3 characters long" }, maxLength: { value: 35, message: "Store Name cannot be longer than 30 characters." } })} />
                                            ...
                                            <div>
                                                ...
                                                <input id="storePhone" className="bg-white w-full text-base px-4 py-2 border-b border-gray-300 focus:outline-none rounded-2xl focus:border-indigo-500" type="tel" placeholder="Enter your store phone | +90XXXXXXXXXX" {...register("storePhone", { required: { value: true, message: "Store phone is required" }, pattern: { value: /^((\+|00)90|0)?\s?5\d{2}\s?\d{3}\s?\d{2}\s?\d{2}$/, message: "Invalid phone number" } })} />
                                            ...
                                            <div>
                                                ...
                                                <input id="storeTaxNumber" className="bg-white w-full text-base px-4 py-2 border-b border-gray-300 focus:outline-none rounded-2xl focus:border-indigo-500" type="text" placeholder="Enter your store tax number | TXXXXVXXXXXX" {...register("storeTaxNumber", { required: { value: true, message: "Store tax number is required" }, pattern: { value: /^T\d{4}V\d{6}$/, message: "Invalid tax number" } })} />
                                            ...
                                            <div>
                                                ...
                                                <input id="storeIBAN" className="bg-white w-full text-base px-4 py-2 border-b border-gray-300 focus:outline-none rounded-2xl focus:border-indigo-500" type="text" placeholder="Enter your store IBAN | TRXXXXXXXXXXXXXXXXXXXXXXXX" {...register("storeIBAN", { required: { value: true, message: "Store IBAN is required" }, pattern: { value: /^TR\d{2}\s?(\d{4}\s?){1}(\d{1})(\d{3}\s?)(\d{4}\s?){3}(\d{2})\s?$/, message: "Invalid IBAN" } })} />
